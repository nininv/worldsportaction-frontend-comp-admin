...
const AppConstants = {
  ...
  haveYouEverPlayed: 'Have you ever played Basketball before:',
  ...
  hearAboutTheCompetition: 'How did you hear about this Basketball Competition?',
  ...
  favouriteTeam: 'Favourite Basketball Team',
  ...
  termsAndConditionsLinkOfWorldSportAction:
    'https://storage.googleapis.com/download/storage/v1/b/world-sport-action-dev-c1019.appspot.com/o/%2Forganisation%2FtermsAndCondition_org_18238b32-1d44-40a3-b72a-0c106315bf9f_1617390905373.pdf?generation=1617390915516798&alt=media',
  ...
  otherQuestions: 'Other Basketball Questions',
  netballQuestions: 'Basketball Questions',
  ...
  todayMatchMsg:
    'A list of all the matches being played on this day. This list shows whether scorers have been set, attendance has been taken and if referees have been recorded(optional). Please refresh your screen to get the latest updates.',
  playersToPayMsg:
  ...
  membershipSeasonalFeeMsg: 'Fee charged to join a Basketball competition.',
  firstComRegOnlyMsg:
  ...
  activeUmpireCoach: 'Activate Referee Coaches',
  ...
  singleUseDiscountSubject:
    'Your Single Use discount voucher to use with your Basketball Registration',
  addCode: 'Add Code',
  go: 'Go',
  ...
  editOrganisationMessage:
    'If you edit the organisations, please ensure all teams are linked to the correct organisation so that managers, scorers, referees and coaches remain correctly linked to this competition. Would you like to proceed?',
  ...
  nationalAccreditationLevelUmpireQ: 'What is your national accreditation level (Referee)?',
  nationalAccreditationLevelUmpire: 'National accreditation level (Referee)',
  ...
  addUmpireToPool: 'Add referee to pool',
  toPool: 'to pool',
  umpireAlreadyInPool: 'This referee is already added to this pool.',
  confirmUnassignMsg:
    'This referee is also added to another pool. Would you like to move them to Unassigned section?',
