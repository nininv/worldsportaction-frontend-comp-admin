...
const AppConstants = {
  ...
  childrenCheckNumberInfo: 'Working with Children Check Number (You are required to have a working with Children Number. If you don’t have one you will need to apply.)',
  ...
  LatitudeMsg: `1. Go to google maps https://www.google.com/maps\n\n'
    ...
    teamExistingMsg: 'Add a user who has either created an account in the App, is an administrator or has registered.',
    ...
    equallyRotateHomeAwayMsg: 'Choose Equally rotate teams home/away venue competition if competition features Home and Away venues.',
    equallyRotateCentralizedVenueMsg: 'Choose Equally rotate teams - centralised venue competition if competition is run at centralised venues.',

    /// /Competition Format Screen
    applyMatchFormatMsg: 'Choose whether the match format is applied to all Divisions or whether it is different for particular Divisions.',
    applyFinalFormatMsg: 'Choose to enable Finals. Apply Final format to all Divsions or by particular Division. ',
    ...
    childMsg2Admin: 'You have elected to use the same email for the Child and Parent. The child will not get their own log-in. If you would like them to have their own log-in please give them a separate email address.',
    ...
    parentMsg2Admin: 'You have elected to use the same email for the Child and Parent. The child will not retain their own login. If you would like them to have their own login please give them a separate email address first.',
    ...
    regoFormConfirmMsg: 'Some users may receive this email a second time. Do you want to proceed with an email notification?',
    ...
    imageSizeFormatText: 'Selected file must be less then 2 MB and jpg, jpeg, png, webp formats are supported.',
