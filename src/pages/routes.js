    ...
    return (
      <Switch>
        ...
        <PrivateRoute
          path="/dashboard"
          component={
            this.haveAccess(userRoleId, '/dashboard') ? lazyLoad(Dashboard) : lazyLoad(NotFound)
          }
        />
        ...
        <PrivateRoute
          ...
          component={
            this.haveAccess(userRoleId, '/competitionLadder')
        ...
        <PrivateRoute
          ...
          component={
            this.haveAccess(userRoleId, '/competitionVenueAndCourts')
        ...
        <PrivateRoute
          path="/productAdd"
          component={
            this.haveAccess(userRoleId, '/productAdd') ? lazyLoad(ProductAdd) : lazyLoad(NotFound)
          }
        />
        <PrivateRoute
          path="/registration"
        ...
        <PrivateRoute
          ...
          component={
            this.haveAccess(userRoleId, '/productAddRegistration')
        ...
        <PrivateRoute
          ...
          component={
            this.haveAccess(userRoleId, '/productRegistrationClub')
        ...
        <PrivateRoute
          ...
          component={
            this.haveAccess(userRoleId, '/userGraphicalDashboard')
        ...
        <PrivateRoute
          path="/userMedical"
          component={
            this.haveAccess(userRoleId, '/userMedical')
              ? lazyLoad(userModuleMedical)
              : lazyLoad(NotFound)
          }
        />
        <PrivateRoute
        ...
        <PrivateRoute
          ...
          component={
            this.haveAccess(userRoleId, '/registrationList')
              ? lazyLoad(RegistrationList)
              : lazyLoad(NotFound)
          }
        />
        <PrivateRoute
        ...
        <PrivateRoute
          ...
          component={
            this.haveAccess(userRoleId, '/affiliateDirectory')
        ...
        <PrivateRoute
          ...
          component={
            this.haveAccess(userRoleId, '/appRegistrationForm')
              ? lazyLoad(AppRegistrationForm)
              : lazyLoad(NotFound)
          }
        />
        <PrivateRoute
        ...
        <PrivateRoute
          ...
          component={
            this.haveAccess(userRoleId, '/matchDayManagerView')
              ? lazyLoad(LiveScoreManagerView)
              : lazyLoad(NotFound)
          }
        />
        ...
        <PrivateRoute
          ...
          component={
            this.haveAccess(userRoleId, '/matchDayUmpireList')
              ? lazyLoad(LiveScoreUmpireList)
              : lazyLoad(NotFound)
          }
        />
        ...
        <PrivateRoute
          ...
          component={
            this.haveAccess(userRoleId, '/matchDayPlayerView')
              ? lazyLoad(LiveScorePlayerView)
              : lazyLoad(NotFound)
          }
        />
        ...
        <PrivateRoute
          ...
          component={
            this.haveAccess(userRoleId, '/matchDayPublicLadder')
              ? lazyLoad(LiveScorePublicLadder)
              : lazyLoad(NotFound)
          }
        />
        ...
        <PrivateRoute
          ...
          component={
            this.haveAccess(userRoleId, '/matchDaySeasonFixture')
              ? lazyLoad(LiveScoreSeasonFixture)
              : lazyLoad(NotFound)
          }
        />
        ...
        <PrivateRoute
          path="/spectator"
          component={
            this.haveAccess(userRoleId, '/spectator') ? lazyLoad(Spectator) : lazyLoad(NotFound)
          }
        />
        ...
        <PrivateRoute
          ...
          component={
            this.haveAccess(userRoleId, '/matchDayUmpireImport')
              ? lazyLoad(LiveScoreUmpireImport)
              : lazyLoad(NotFound)
          }
        />
        ...
        <PrivateRoute
          path="/umpirePayout"
          component={
            this.haveAccess(userRoleId, '/umpirePayout')
              ? lazyLoad(UmpirePayout)
              : lazyLoad(NotFound)
          }
        />
