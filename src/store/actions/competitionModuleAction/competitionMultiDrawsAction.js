...
function getCompetitionDrawsAction(
  yearRefId,
  competitionId,
  venueId,
  roundId,
...
function updateCompetitionDraws(
  data,
  source,
  target,
  actionType,
...
function updateCourtTimingsDrawsAction(
  data,
  source,
  target,
  actionType,
...
function updateCourtTimingsDrawsDragSuccessAction(
  data,
  source,
  target,
  actionType,
...
function updateCompetitionDrawsSwapLoadAction(
  data,
  source,
  target,
  actionType,
