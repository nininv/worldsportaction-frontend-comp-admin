        ...
        if (compInvitees.length === 1) {
          if (
            ...
            if (compInvitees[0].inviteesRefId === 5 || compInvitees[0].inviteesRefId === 6) {
              ...
              let anyOrgValue = getAnyOrgValue(
      ...
      return {
        ...
        form: {
          ...
          gameTimeTrackingType:
            payload.gameTimeTrackingType != null ? payload.gameTimeTrackingType : 0,
          ...
          attendanceRecordingPeriod: payload.gameTimeTracking
            ? 'PERIOD'
            : payload.attendanceRecordingPeriod,
          ...
          additionalTime: payload.additionalSettings ? !!payload.additionalSettings.ALLOWED_ADDITIONAL_TIME : false,
