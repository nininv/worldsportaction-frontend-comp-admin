                ...
                <div>
                  ...
                  <div className="row">
                    <div className="col-sm-6">
                      <InputWithHead
                        heading={AppConstants.finalsStartDate}
                        required="required-field"
                      />
                      <Form.Item
                        name={`finalsStartDate${index}`}
                        rules={[
                          { required: true, message: ValidationConstants.finalsStartDateRequired },
                        ]}
                      >
                        <DatePicker
                  ...
                  {this.isShowPlayOff3rdPosition(data) && (
                    <Checkbox
                      ...
                      onChange={e =>
                        this.onChangeSetValue(e.target.checked ? 1 : 0, 'playOff3rdposition', index)
                      }
                    >
                              ...
                              <div className="col-md-6">
                                ...
                                >
                                  <Select
                                    ...
                                    onChange={e =>
                                      this.onChangeSetValue(e, 'wpwPool1', index, whoPlaysWhoIndex)
                                    }
                                  >
                              ...
                              <div className="col-md-6">
                                ...
                                >
                                  <Select
                                    ...
                                    onChange={e =>
                                      this.onChangeSetValue(e, 'wpwPool2', index, whoPlaysWhoIndex)
                                    }
                                  >
                                    {(whoPlaysWhoItem.pools || []).map(pool => (
                              ...
                              <div className="col-md-6">
                                ...
                                >
                                  <Select
                                    ...
                                    onChange={e =>
                                      this.onChangeSetValue(e, 'wpwPool3', index, whoPlaysWhoIndex)
                                    }
                                  >
                                    {(whoPlaysWhoItem.pools || []).map(pool => (
                              ...
                              <div className="col-md-6">
                                ...
                                >
                                  <Select
                                    ...
                                    onChange={e =>
                                      this.onChangeSetValue(e, 'wpwPool4', index, whoPlaysWhoIndex)
                                    }
                                  >
                                    {(whoPlaysWhoItem.pools || []).map(pool => (
