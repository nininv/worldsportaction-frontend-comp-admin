...
class CompetitionPlayerGrades extends Component {
                        ...
                        {this.state.divisionId != null && (
                            <div className="col-sm">
                                <div className="comp-dashboard-botton-view-mobile">
                                    ...
                                    >
                                        <Button id={AppUniqueId.PlayerGrading_ImportBtn} disabled={this.state.competitionStatus == 1} className="primary-add-comp-form" type="primary">
                                            <div className="row">
                                                <div className="col-sm">
                                                    <img
    ...
    onYearChange = (yearId) => {
        ...
        this.props.getYearAndCompetitionOwnAction(this.props.appState.own_YearArr, yearId, 'own_competition');
        this.setState({
            firstTimeCompId: null, yearRefId: yearId, divisionId: null, competitionStatus: 0, compLoad: true,
        });
    }
    ...
    onCompetitionChange = (competitionId) => {
        ...
        const { statusRefId } = own_CompetitionArr[statusIndex];
        const { finalTypeRefId } = own_CompetitionArr[statusIndex];
        setOwn_competitionStatus(statusRefId);
        setOwn_competition(competitionId);
        setOwn_CompetitionFinalRefId(finalTypeRefId);
        this.props.clearReducerCompPartPlayerGradingAction("partPlayerGradingListData");
