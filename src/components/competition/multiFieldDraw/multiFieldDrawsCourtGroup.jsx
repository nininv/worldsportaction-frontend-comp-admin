        ...
        >
          {this.props.firstTimeCompId == '-1' || this.props.filterDates ? (
            <Swappable
              ...
              onSwap={(source, target) => this.props.onSwap(source, target, dateItem.draws, '1')}
            ...
            >
              {slotObject.drawsId != null || slotObject.subCourt ? (
                <Popover
                  content={slotObject.childSlots.map((childSlot, cindex) => {
                    if (childSlot.homeTeamId) {
                      return (
                        <span key={childSlot.homeTeamId + '' + cindex}>
                          {' '}
                          {childSlot.homeTeamName} V {childSlot.awayTeamName}
                          <br />{' '}
                        </span>
                      );
                    }
                  ...
                  <div className="d-flex justify-content-between align-items-center w-100">
                    {childArray.map((columnindex, rindex) => {
                      ...
                      return (
                        <div
                          key={'barRow' + rindex}
                          className={`d-flex justify-content-between align-items-center w-100 ${barHeightClass}`}
                        >
