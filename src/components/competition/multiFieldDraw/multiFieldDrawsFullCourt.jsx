...
class MultiFieldDrawsFullCourt extends Component {
    ...
    updateCompetitionNullDraws = (
        ...
        Object.keys(DrawConstant.switchDrawTimeFields).forEach(key => newSourceObj[key] = sourceObject[key]);
        Object.keys(DrawConstant.switchDrawTimeFields).forEach(key => newTargetObj[key] = targetObject[key]); 
