...
class CompetitionQuickCompetition extends Component {
  ...
  componentDidUpdate(nextProps) {
    ...
    if (
      this.state.timeslotModalLoad === true &&
      this.props.quickCompetitionState.onQuickCompLoad === false
    ) {
  ...
  closeCompModal = () => {
    ...
    this.props.createQuickCompetitionAction(
      this.state.yearRefId ? this.state.yearRefId : JSON.parse(yearId),
      competitionName,
      competitionDate,
    );
    this.setState({
  ...
  nextCompModal = () => {
    const { competitionName, competitionDate, yearId } = this.props.quickCompetitionState;
    this.props.createQuickCompetitionAction(
      this.state.yearRefId ? this.state.yearRefId : yearId,
      competitionName,
      competitionDate,
    );
    this.setState({
    ...
    return (
      <div className="fluid-width">
        ...
        <TimeSlotModal
          ...
          UpdateTimeSlotsDataManual={(startTime, index, timeIndex) =>
            this.props.updateTimeSlot('changeTime', index, timeIndex, startTime)
          }
  ...
  contentView = () => {
    ...
    return (
      <div className="comp-draw-content-view mt-0">
        ...
        {this.state.quickCompetitionLoad ? <div>{this.draggableView()}</div> : this.draggableView()}
      </div>
    );
  };
                  ...
                  return (
                    <div key={slotIndex + 'slotkey'}>
                      ...
                      <Tooltip
                        ...
                        title={
                          slotObject.drawsId && slotObject.divisionName + '-' + slotObject.gradeName
                        }
                      >
                        <div
