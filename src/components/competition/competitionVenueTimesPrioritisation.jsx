...
class CompetitionVenueTimesPrioritisation extends Component {
    ...
    return (
      ...
      <div className="row">
        <div className="col-sm">
          ...
          <Select className="w-100" style={{ minWidth: 182 }} placeholder="Select Court">
            {courtArray.map(item => (
            ...
            {sortedDivisionFieldConfigList.map((field, rowIndex) => {
              ...
              return isRowFull ? (
                <div key={field.description} className="row mt-4 align-items-center">
                  ...
                  <div className="col-sm-9">All other divisions will default to Full</div>
                </div>
              ) : (
  ...
  anyGradePrefenceView() {
    ...
    let allocateSameCourtList = isArrayNotEmpty(courtRotation)
      ? courtRotation[1].subReferences
      : [];
    let disabledStatus = this.state.competitionStatus == 1;
    return (
      <div>
