...
const isUserSuperAdmin = (userRolesFromState = []) => {
  ...
  const isLoggedUserHasSuperAdminRole = userRolesFromState.find(
    role => role.roleId === superAdminRoleId,
  );
    ...
    render: (data, record) => (
      ...
      >
        ...
        >
          ...
          <Menu.Item key="2">
            <span onClick={() => this_Obj.unlinkCheckParent(record)}>
          ...
          <NavLink
            to={{
              ...
              state: {
                ...
                screenKey: this_Obj.state.screenKey,
              },
            }}
          >
            <span
...
class UserModulePersonalDetail extends Component {
  ...
  componentDidUpdate(nextProps) {
    ...
    if (
      ...
      this.state.retryPaymentOnLoad == true
    ) {
                ...
                <div className="table-responsive home-dash-table-view">
                  <Table
                    ...
                    loading={
                      ...
                      this.props.userState.cancelDeRegistrationLoad
                    }
                  />
                </div>
                <div className="d-flex justify-content-end">
              ...
              <div>
                ...
                <div className="table-responsive home-dash-table-view">
                  <Table
                    ...
                    pagination={false}
                    loading={this.props.userState.userRegistrationOnLoad}
                  />
                </div>
                <div className="d-flex justify-content-end">
                  <Pagination
            ...
            <div className="row">
              ...
              this.state.registrationTeam.isRemove ? (
                <div
                  ...
                  onClick={() => this.gotoAddTeamMember()}
                >
