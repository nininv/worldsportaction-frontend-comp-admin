    ...
    componentDidUpdate(nextProps){
       ...
       let affiliateTo = this.props.userState.affiliateTo;
        ...
        if (nextProps.userState !== userState) {
            if (userState.affiliateOnLoad === false && this.state.getDataLoading == true) {
                this.setState({
                    getDataLoading: false
                });
...
export default connect(mapStatetoProps,mapDispatchToProps)(Form.create()(UserEditAffiliates));
