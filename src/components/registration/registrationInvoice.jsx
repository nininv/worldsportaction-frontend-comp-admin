      ...
      <div className="content-view pt-4 pb-0">
        <div className="drop-reverse">
          <div className="col-sm">
            ...
            <InputWithHead heading="Receipt No.1234497" />
            ...
            {userDetail && (userDetail.suburb || userDetail.street1) && (
              <Descriptions>
                <Descriptions.Item className="pb-0">
                  {userDetail.suburb} {userDetail.street1} {userDetail.street2}
                </Descriptions.Item>
              </Descriptions>
            )}
            {userDetail && userDetail.postalCode && (
              <Descriptions>
                <Descriptions.Item>{userDetail.postalCode} </Descriptions.Item>
              </Descriptions>
            )}
        ...
        <div>
          <div className="row">
            ...
            <div className="col-sm invoice-description">
              <InputWithHead
                heading={(
                  Number(membershipDetail.mCasualFee) + Number(membershipDetail.mSeasonalFee)
                ).toFixed(2)}
              />
            </div>
            <div className="col-sm invoice-description">
            ...
            <div className="col-sm invoice-description">
              <InputWithHead
                heading={(
                  Number(membershipDetail.mCasualGst) + Number(membershipDetail.mSeasonalGst)
                ).toFixed(2)}
              />
            </div>
            <div className="col-sm">
              <InputWithHead
                required="invoice"
                heading={(
                  Number(membershipDetail.mCasualFee) +
                  Number(membershipDetail.mSeasonalFee) +
                  Number(membershipDetail.mCasualGst) +
                  Number(membershipDetail.mSeasonalGst)
                ).toFixed(2)}
              />
            </div>
          </div>
    ...
    <div className="row">
      ...
      <div className="invoice-col-View pr-0 pl-0">
        {competitionDetails && competitionDetails.cOrganisationName && (
          <InputWithHead heading={`${competitionDetails.cOrganisationName} Competition Fees`} />
        )}
      </div>
      <div className="invoice-col-view-30 pb-0 pl-0 pr-0">
        <div>
          <div className="row">
            ...
            <div className="col-sm invoice-description">
              <InputWithHead
                heading={(
                  Number(competitionDetails.cCasualFee) + Number(competitionDetails.cSeasonalFee)
                ).toFixed(2)}
              />
            </div>
            <div className="col-sm invoice-description">
            ...
            <div className="col-sm invoice-description">
              <InputWithHead
                heading={(
                  Number(competitionDetails.cCasualGst) + Number(competitionDetails.cSeasonalGst)
                ).toFixed(2)}
              />
            </div>
            <div className="col-sm">
              <InputWithHead
                required="invoice"
                heading={(
                  Number(competitionDetails.cCasualFee) +
                  Number(competitionDetails.cSeasonalFee) +
                  (Number(competitionDetails.cCasualGst) + Number(competitionDetails.cSeasonalGst))
                ).toFixed(2)}
              />
            </div>
    ...
    <div className="row">
      <div className="invoice-col-View pb-0 pr-0 pl-0">
        {affiliateDetail && affiliateDetail.aOrganisationName && (
          <InputWithHead heading={`${affiliateDetail.aOrganisationName} Competition Fees`} />
        )}
      </div>
      <div className="invoice-col-view-30 pb-0 pl-0 pr-0">
        <div>
          <div className="row">
            ...
            <div className="col-sm invoice-description">
              {affiliateDetail && (
                <InputWithHead
                  heading={(
                    Number(affiliateDetail.aCasualFee) + Number(affiliateDetail.aSeasonalFee)
                  ).toFixed(2)}
                />
              )}
            </div>
            ...
            <div className="col-sm invoice-description">
              {affiliateDetail && (
                <InputWithHead
                  heading={(
                    Number(affiliateDetail.aCasualGst) + Number(affiliateDetail.aSeasonalGst)
                  ).toFixed(2)}
                />
              )}
            </div>
            <div className="col-sm">
              {affiliateDetail && (
                <InputWithHead
                  required="invoice"
                  heading={(
                    Number(affiliateDetail.aCasualFee) +
                    Number(affiliateDetail.aSeasonalFee) +
                    (Number(affiliateDetail.aCasualGst) + Number(affiliateDetail.aSeasonalGst))
                  ).toFixed(2)}
                />
              )}
    ...
    return (
      <div className="content-view pt-0 pb-0">
        ...
        {/* {data.membership && data.membership.map((membershipItem, membershipIndex) => {
                    return ( */}
        {data &&
          data.map((participantItem, participantIndex) => {
                        ...
                        <InputWithHead
                          heading={
                            competitionDetails.competitionDivisionName
                              ? `Registration - ${membershipDetail.mTypeName} ${userDetail.firstName} ${userDetail.lastName}, ${competitionDetails.competitionName}, ${competitionDetails.competitionDivisionName}`
                              : `Registration - ${membershipDetail.mTypeName} ${userDetail.firstName} ${userDetail.lastName}, ${competitionDetails.competitionName}`
                          }
                        />
                      )}
                    </div>
          ...
          <div className="col-sm pl-0 pr-0">
            <div className="col-sm d-flex justify-content-end">
              <div className="col-sm-8 d-flex justify-content-end">
                <InputWithHead required="pr-4" heading="Subtotal" />
              </div>
              <InputWithHead
            ...
            <div className="col-sm d-flex justify-content-end">
              <div className="col-sm-8 d-flex justify-content-end">
                <InputWithHead required="pr-4 pt-0" heading="GST" />
              </div>
              <InputWithHead
                required="pt-0"
                className="d-flex justify-content-start"
            ...
            <div className="col-sm d-flex justify-content-end">
              <InputWithHead required="pr-4 pt-0" heading="Amount Due" />
              <InputWithHead
                required="pt-0"
                className="d-flex justify-content-start"
