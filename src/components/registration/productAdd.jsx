...
class ProductAdd extends Component {
    ...
    return (
      <div className="header-view">
        ...
        <div className="registration-product-view">
          ...
          <Button>Registration Products</Button>
          {/* </NavLink> */}
        </div>
      </div>
    );
  ...
  ShowRegistrationDetailTree = tree => {
    ...
    return tree.map((item, catIndex) => {
      return (
        <TreeNode
          title={this.registrationDetailNode(item)}
          key={catIndex}
  ...
  showParentDetailRequiredNode(item, catIndex, scatIndex) {
    const { TreeNode } = Tree;
    return item.children.map((parentItem, parentIndex) => {
      return (
        <TreeNode
  ...
  makeParentDetailRequiredNode(parentItem) {
    return <span>{parentItem.title}</span>;
  }
  ...
  feesView = () => {
    return (
      <div className="fees-view pt-5">
        ...
        >
          <Option value="differentiateBy1&2Registration">
            Differentiate by 1st registration and 2nd+ registration
          </Option>
        </Select>
        <div className="inside-container-view">
  ...
  discountView = () => {
    return (
      <div className="discount-view pt-5">
        ...
        <div className="inside-container-view">
          <Checkbox className="single-checkbox mt-1" onChange={e => this.onChange(e)}>
  ...
  advancedSettingView = () => {
    const advancedSetting = [
      'Allow Team Preference',
      'Manually approve all new registrations',
      'Allow people to invite friends',
    ];
  ...
  ShowGovernemntRebateSettingTree = tree => {
    ...
    return tree.map((item, catIndex) => {
      return (
        <TreeNode
          title={this.governamentRebateNode(item)}
          key={catIndex}
          defaultCheckedKeys={'Government Rebate'}
        >
      ...
      <div className="fluid-width default-bg">
        ...
        <Layout>
          ...
          <Content>
            ...
            <div className="formView">{this.paymentView()}</div>
