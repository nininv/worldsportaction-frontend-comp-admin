...
class RegistrationInvoice extends Component {
  ...
  componentDidMount() {
    let paymentSuccess = this.props.location.state
  ...
  getInvoiceStatusAPI = () => {
    ...
    let registrationId = this.props.location.state
      ? this.props.location.state.registrationId
      : null;
    let teamMemberRegId = this.props.location.state
  ...
  headerView = () => {
    return (
      <Header className="comp-player-grades-header-view container  mt-0">
        <div className="row">
          <div className="col-sm" style={{ display: 'flex', alignContent: 'center' }}></div>
        </div>
      </Header>
    );
  };
  ...
  topView = result => {
    ...
    let isSchoolRegistrationApplied =
      invoiceData != null ? invoiceData.isSchoolRegistrationApplied : 0;
    let msg =
      isSchoolRegistrationApplied == 1 ? '(' + AppConstants.toBeInvoicedViaSchool + ')' : '';
    return (
    ...
    return (
      <div className="row">
        <div className="col-md-3 col-8 pb-0 pr-0 pl-0 ">
          <InputWithHead
            heading={
              mOrganisationName + ' - ' + membershipProductName + ' Membership Fees - ' + mTypeName
            }
      ...
      <div className="content-view pt-0 pb-0">
        ...
        {data &&
          ...
          data.map((item, participantIndex) => {
            ...
            let tShirtDetails = tShirtSizeList
      ...
      <div className="content-view">
        <div className="drop-reverse">
          ...
          <div className="col-sm pl-0 pr-0">
            ...
            <div className="col-sm d-flex justify-content-end p-0">
              <div className="col-8  pr-0" style={{ display: 'flex', justifyContent: 'flex-end' }}>
                <InputWithHead required={'pt-0'} heading={'GST'} />
              </div>
              <div className="col-sm invoice-right-column pr-0">
                <InputWithHead
                  required={'pt-0'}
            ...
            <div className="col-sm d-flex justify-content-end p-0">
              <div className="col-8 pr-0" style={{ display: 'flex', justifyContent: 'flex-end' }}>
                <InputWithHead required={'pt-0'} heading={'Charity'} />
              </div>
              <div className="col-sm invoice-right-column pr-0">
                <InputWithHead
                  required={'pt-0'}
            ...
            <div className="col-sm d-flex justify-content-end p-0">
              <div className="invoice-amount-border col-8 px-0 d-flex justify-content-end">
                <InputWithHead required={'pt-3'} heading={'Total'} />
              </div>
            ...
            <div className="col-sm d-flex justify-content-end p-0">
              <div className="col-8 px-0  d-flex justify-content-end">
                <InputWithHead required={'pt-3'} heading={'Transaction Fee'} />
              </div>
              <div className="col-sm invoice-right-column pr-0">
                <InputWithHead
                  required={'pt-3'}
  ...
  thankYouRegisteringView = () => {
    ...
    return (
      <div className="thank-you-registering-view">
        ...
        {userId != 0 ? (
          <div
            className="btn-text-common pointer"
            style={{ marginLeft: 'auto', marginRight: 0, minWidth: 85 }}
            onClick={() => this.gotoUserPage(userId)}
          >
