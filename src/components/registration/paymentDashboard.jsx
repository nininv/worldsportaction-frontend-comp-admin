...
const columns = [
  ...
  },
  {
    ...
    render: (affiliateName) => (
      <span>
        {affiliateName === null || affiliateName === "" ? "N/A" : affiliateName}
      </span>
    ),
  },
  {
  ...
  },
  {
    ...
    render: (governmentVoucherAmount, record) => {
      return (
        <div
          className={
            record.governmentVoucherStatusRefId != 2 &&
            parseFloat(governmentVoucherAmount) > 0 &&
  ...
  refundAmountModalPopUp = () => {
    return (
      <Modal
        ...
        onCancel={() =>
          this.setState({ showRefundModalVisible: false, refundRecord: null })
        }
        ...
        <div className="row pb-5">
          <div className="col-sm-3">
            ...
            >
              ...
              <Option key="playerRegistration" value="playerRegistration">
                {AppConstants.playerRegistration}
              </Option>
              <Option key="coachRegistration" value="coachRegistration">
                {AppConstants.coachRegistration}
              </Option>
              <Option key="teamRegistration" value="teamRegistration">
                {AppConstants.teamRegistration}
              </Option>
              <Option key="shop" value="shop">
                {AppConstants.shop}
              </Option>
              <Option key="umpire" value="umpire">
                {AppConstants.umpire}
              </Option>
            </Select>
          </div>
        ...
        <div className="row pb-2">
          <div className="col-sm-3">
            ...
            <Select
              ...
              style={{ paddingRight: 1, minWidth: 160 }}
              onChange={(feeType) =>
                this.onChangeDropDownValue(feeType, "feeType")
              }
          ...
          <div className="col-sm-3 pt-2">
            ...
            >
              ...
              {this.props.appState.discountMethod.map((discountMethod) => (
                <Option
                  key={`discountMethod_${discountMethod.id}`}
