      ...
      <div className="fluid-width mt-2">
        ...
        <div className="profile-image-view mr-5">
          ...
          <img
            ...
            src={
              'https://content.fortune.com/wp-content/uploads/2019/12/GettyImages-1187428380.jpg'
            }
            alt=""
            height="80"
            width="80"
        ...
        <span className="desc-text-style side-bar-profile-data pt-0">
          {AppConstants.aboutManager}
        </span>
