                        ...
                        <div className="col-sm-10 col-md-9">
                            <div className="reg-add-save-button p-0">
                                <Button
                                    ...
                                    onClick={() => history.push(this.state.key === 'dashboard' ? 'liveScoreDashboard' : this.state.key === 'umpireRoaster' ? 'umpireRoaster' : this.state.umpireKey === 'umpire' ? 'umpireDashboard' : '/matchDayMatches')}
                                    type="cancel-button"
                                >
                                    {AppConstants.cancel}
                                </Button>
