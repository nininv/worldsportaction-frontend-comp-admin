    ...
    if (nextProps.liveScoreMatchState !== this.props.liveScoreMatchState) {
      ...
      if (this.props.liveScoreMatchState.updateUmpireFetchCall) {
        ...
        let endTime = moment(startTime)
          .add(matchData.matchDuration, 'minutes')
  ...
  contentView = () => {
    ...
    return (
      <div className="content-view pt-4">
              ...
              >
                ...
                >
                  {isArrayNotEmpty(teamResult) &&
                    teamResult.map(item => (
                      <Option key={`homeTeam_${item.id}`} value={item.id}>
                        {item.name}
                      </Option>
                    ))}
                </Select>
            ...
            <div className="col-sm-6">
              ...
              >
                ...
                >
                  {isArrayNotEmpty(teamResult) &&
                    teamResult.map(item => (
                      <Option key={`awayTeam_${item.id}`} value={item.id}>
                        {item.name}
                      </Option>
                    ))}
                </Select>
        ...
        {recordUmpireType === 'NONE' ? null : recordUmpireType === 'USERS' ? (
          <div>
            <div className="row">
              <div className="col-sm">
            ...
            <div className="row">
              <div className="col-sm">
                ...
                <Select
                  className="w-100"
                  style={{ paddingRight: 1, minWidth: 182 }}
                  onChange={umpireReserve =>
                    this.props.liveScoreUpdateMatchAction(umpireReserve, 'umpireReserve')
                  }
              ...
              <div className="col-sm">
                ...
                <Select
                  ...
                  onChange={umpireCoach =>
                    this.props.liveScoreUpdateMatchAction(umpireCoach, 'umpireCoach')
                  }
                  ...
                  >
                    {isArrayNotEmpty(clubListData) &&
                      clubListData.map(item => (
                        <Option key={`umpire1Org_${item.id}`} value={item.id}>
                          {item.name}
                        </Option>
                      ))}
                  </Select>
            ...
            <div className="row">
              ...
              <div className="col-sm">
                ...
                <InputNumber
                  ...
                  placeholder="0"
                  onChange={matchDuration =>
                    this.props.liveScoreUpdateMatchAction(matchDuration, 'extraTimeMainBreak')
                  }
              ...
              {addEditMatch.extraTimeType === 'FOUR_QUARTERS' && (
                <div className="col-sm">
                  ...
                  <InputNumber
                    ...
                    placeholder="0"
                    onChange={matchDuration =>
                      this.props.liveScoreUpdateMatchAction(matchDuration, 'extraTimeqtrBreak')
                    }
