...
import { Layout, Breadcrumb, Select, Checkbox, Button, Form, Modal } from 'antd';
          ...
          <div className="col-sm">
            ...
            <div>
              <a
                ...
                href={
                  process.env.REACT_APP_USER_REGISTRATION_URL +
                  `/liveScorePublicLadder?organisationKey=${organisationUniqueKey}`
                }
                target="_blank"
          ...
          <div className="col-sm">
            ...
            <div>
              <a
                ...
                href={
                  process.env.REACT_APP_USER_REGISTRATION_URL +
                  `/livescoreSeasonFixture?organisationKey=${organisationUniqueKey}`
                }
                target="_blank"
                rel="noopener noreferrer"
              >
  ...
  render() {
    return (
      <div className="fluid-width default-bg">
        ...
        <Loader
          visible={this.props.ladderSettingState.loader || this.props.ladderSettingState.onLoad}
        />
        <Layout>
          {this.headerView()}
          {/* <Content> */}
