...
const LiveScoreSettingsTimeoutsFields = ({
    isVisible = true, values, onFormChange, formRef,
}) => {
                                        ...
                                        return (
                                            <div key={timeoutOption.key + index} className="col-auto">
                                                <Form.Item
                                                    ...
                                                    initialValue={
                                                        getTimeoutsValue(timeoutOption.stateKey, index)
                                                    }
                                                >
                                                    <InputWithHead
                                                        required="pt-0"
                                                        ...
                                                        onChange={(e) => handleTimeoutInputChange(
                                                            e,
                                                            timeoutOption.stateKey,
                                                            index,
                                                        )}
                                                    />
                                                </Form.Item>
