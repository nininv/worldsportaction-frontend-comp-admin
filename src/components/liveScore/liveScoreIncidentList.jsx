...
const columns = [
    ...
    },
    {
        ...
        render: (matchId) => (
            <NavLink to={{
                ...
                state: { matchId, screenName: 'incident', umpireKey: this_Obj.props.liveScoreIncidentState.umpireKey },
            }}
            >
    ...
    },
    {
        ...
        render: (row) => {
            ...
            if (isIncident) {
                return isArrayNotEmpty(incidentPlayers) && incidentPlayers.map((item, index) => (
                    <span
