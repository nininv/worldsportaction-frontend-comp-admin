...
function tableSort(key) {
  ...
  if (this_obj.state.selectedComp)
    this_obj.props.getUmpirePaymentData({
...
const columns = [
  ...
  },
  {
    ...
    render: (selectedValue, record, index) => {
      return (record.user && record.user.stripeAccountId) || record.paymentStatus === 'paid' ? (
        <Checkbox
      ...
      <div className="fluid-width">
        <div className="row">
          <div className="col-sm pt-1 d-flex align-content-center">
            <span className="form-heading">{AppConstants.umpirePayments}</span>
          </div>
        ...
        <div className="fluid-width">
          <div className="row">
            ...
            >
              ...
              <div className="comp-dashboard-botton-view-mobile pb-3">
                <Checkbox
                  className="single-checkbox"
                  checked={paymentStatus}
                  disabled={onLoad || this.props.umpireCompetitionState.onLoad}
                  onChange={e =>
                    this.props.updateUmpirePaymentData({
                      data: e.target.checked,
                      key: 'allCheckBox',
                    })
                  }
        ...
        <div className="row">
          ...
          <div className="col-sm">
            <div className="comp-buttons-view">
              <Button
                onClick={() => this.umpireTransferData(0)}
              ...
              <Button
                onClick={
                  paymentTransferPostData.length > 0
                    ? this.showConfirm
                    : () => this.umpireTransferData(1)
                }
    ...
    return (
      <div className="fluid-width default-bg">
        ...
        <Layout>
          ...
          <Footer>{umpirePaymentList.length > 0 && this.footerView()}</Footer>
        </Layout>
      </div>
    );
  }
