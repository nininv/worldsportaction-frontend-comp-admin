            ...
            <div className="draggable-wrap draw-data-table">
                <div className="scroll-bar">
                    ...
                    <div className="main-canvas Draws">
                        ...
                        <span className="border big-border left-25"></span>
                        ...
                        <span className="border left-135 top-48 border-36"></span>
                        <div className="only-box purple-box left-135 top-48 box-36 purple-dark">
                            <span>
                                Joyce Hayes
                     </span>
                        </div>
                        <span className="border left-135 top-84 border-36"></span>
                        ...
                        <span className="border left-245 top-48 border-36"></span>
                        <div className="only-box green-box left-245 top-48 box-36 green-dark">
                            <span>
                                Cynthia Reed
                     </span>
                        </div>
                        <span className="border left-245 top-84 border-36"></span>
                        <div className="only-box green-box left-245 top-84 box-36 green-dark">
                            <span>
                                Marilyn Henry
                     </span>
                        </div>
                        <span className="border left-355"></span>
                        ...
                        <span className="border left-465 top-48 border-36"></span>
                        <div className="only-box blue-box left-465 top-48 box-36 blue-dark">
                            <span>
                                Jacqueline A...
                     </span>
                        </div>
                        <span className="border left-465 top-84 border-36"></span>
                        <div className="only-box blue-box left-465 top-84 box-36 blue-dark">
                            <span>
                                Carolyn Davi...
                     </span>
                        </div>
                        <span className="border left-575"></span>
                        ...
                        <span className="border left-575 top-48 border-36"></span>
                        <div className="only-box red-box left-575 top-48 box-36 red-dark">
                            <span>
                                Rose Sullivan
                     </span>
                        </div>
                        <span className="border left-575 top-84 border-36"></span>
                        <div className="only-box red-box left-575 top-84 box-36 red-dark">
                            <span>
                                Sara McDon...
                     </span>
                        </div>
                        <span className="border left-685"></span>
                        ...
                        <span className="border left-685 top-48 border-36"></span>
                        <div className="only-box blue-box left-685 top-48 box-36 blue-dark">
                            <span>
                                Jean Wheeler
                     </span>
                        </div>
                        <span className="border left-685 top-84 border-36"></span>
                        <div className="only-box blue-box left-685 top-84 box-36 blue-dark">
                            <span>
                                Sarah Holmes
                     </span>
                        </div>
                        <span className="border left-795"></span>
                        ...
                        <span className="border left-795 top-48 border-36"></span>
                        <div className="only-box blue-box left-795 top-48 box-36 blue-dark">
                            <span>
                                Cynthia Reed
                     </span>
                        </div>
                        <span className="border left-795 top-84 border-36"></span>
                        <div className="only-box blue-box left-795 top-84 box-36 blue-dark">
                            <span>
                                Marilyn Henry
                     </span>
                        </div>
                        <span className="border left-905"></span>
                        ...
                        <span className="border left-905 top-48 border-36"></span>
                        <div className="only-box blue-box left-905 top-48 box-36 blue-dark">
                            <span>
                                Cynthia Reed
                     </span>
                        </div>
                        <span className="border left-905 top-84 border-36"></span>
                        ...
                        <span className="border big-border top-144 left-25"></span>
                        <div className="big-undraggble-box big-box left-25 top-144 grey--bg">
                            <span>
                                N/a
                     </span>
                        </div>
                        <span className="border left-135 top-144"></span>
                        ...
                        <span className="border left-135 top-192 border-36"></span>
                        <div className="only-box purple-box left-135 top-192 box-36 purple-dark">
                            <span>
                                Sara Cole
                     </span>
                        </div>
                        <span className="border left-135 top-228 border-36"></span>
                        <div className="only-box purple-box left-135 top-228 box-36 purple-dark">
                            <span>
                                Evelyn Keller
                     </span>
                        </div>
                        <span className="border left-245 top-144"></span>
                        ...
                        <span className="border left-245 top-192 border-36"></span>
                        <div className="only-box green-box left-245 top-192 box-36 green-dark">
                            <span>
                                Julia Carr
                     </span>
                        </div>
                        <span className="border left-245 top-228 border-36"></span>
                        <div className="only-box green-box left-245 top-228 box-36 green-dark">
                            <span>
                                Debra Peters
                     </span>
                        </div>
                        <span className="border left-355 top-144"></span>
                        ...
                        <span className="border left-465 top-192 border-36"></span>
                        <div className="only-box blue-box left-465 top-192 box-36 blue-dark">
                            <span>
                                Carol McDo...
                     </span>
                        </div>
                        <span className="border left-465 top-228 border-36"></span>
                        <div className="only-box blue-box left-465 top-228 box-36 blue-dark">
                            <span>
                                Helen Rivera
                     </span>
                        </div>
                        <span className="border left-575 top-144"></span>
                        ...
                        <span className="border left-575 top-192 border-36"></span>
                        <div className="only-box red-box left-575 top-192 box-36 red-dark">
                            <span>
                                Shirley Martin
                     </span>
                        </div>
                        <span className="border left-575 top-228 border-36"></span>
                        <div className="only-box red-box left-575 top-228 box-36 red-dark">
                            <span>
                                Betty Medina
                     </span>
                        </div>
                        <span className="border left-685 top-144"></span>
                        ...
                        <span className="border left-685 top-192 border-36"></span>
                        <div className="only-box red-box left-685 top-192 box-36 red-dark">
                            <span>
                                Sharon Collins
                     </span>
                        </div>
                        <span className="border left-685 top-228 border-36"></span>
                        <div className="only-box red-box left-685 top-228 box-36 red-dark">
                            <span>
                                Tammy Torres
                     </span>
                        </div>
                        <span className="border left-795 top-144"></span>
                        ...
                        <span className="border left-795 top-192 border-36"></span>
                        <div className="only-box blue-box left-795 top-192 box-36 blue-dark">
                            <span>
                                Cynthia Reed
                     </span>
                        </div>
                        <span className="border left-795 top-228 border-36"></span>
                        <div className="only-box blue-box left-795 top-228 box-36 blue-dark">
                            <span>
                                Marilyn Henry
                     </span>
                        </div>
                        <span className="border left-905 top-144"></span>
                        ...
                        <span className="border left-905 top-192 border-36"></span>
                        <div className="only-box blue-box left-905 top-192 box-36 blue-dark">
                            <span>
                                Cynthia Reed
                     </span>
                        </div>
                        <span className="border left-905 top-228 border-36"></span>
                        ...
                        <span className="border left-25 top-288"></span>
                        ...
                        <span className="border left-25 top-336 border-36"></span>
                        <div className="only-box green-box left-25 top-336 box-36 green-dark">
                            <span>
                                Marilyn Miller
                     </span>
                        </div>
                        <span className="border left-25 top-372 border-36"></span>
                        <div className="only-box green-box left-25 top-372 box-36 green-dark">
                            <span>
                                Heather Jen...
                     </span>
                        </div>
                        <span className="border left-135 top-288"></span>
                        ...
                        <span className="border left-245 top-336 border-36"></span>
                        <div className="only-box red-box left-245 top-336 box-36 red-dark">
                            <span>
                                Maria Ford
                     </span>
                        </div>
                        <span className="border left-245 top-372 border-36"></span>
                        <div className="box left-245 top-372 box-36 red-dark">
                            <span>
                                Beverly Curtis
                     </span>
                        </div>
                        <span className="border left-355 top-288"></span>
                        ...
                        <span className="border left-465 top-336 border-36"></span>
                        <div className="only-box red-box left-465 top-336 box-36 red-dark">
                            <span>
                                Brenda Ortega
                     </span>
                        </div>
                        <span className="border left-465 top-372 border-36"></span>
                        <div className="only-box red-box left-465 top-372 box-36 red-dark">
                            <span>
                                Brenda Ortega
                     </span>
                        </div>
                        <span className="border left-575 top-288"></span>
                        ...
                        <span className="border left-575 top-336 border-36"></span>
                        <div className="only-box orange-box left-575 top-336 box-36 orange-dark">
                            <span>
                                Megan Baker
                     </span>
                        </div>
                        <span className="border left-575 top-372 border-36"></span>
                        <div className="only-box orange-box left-575 top-372 box-36 orange-dark">
                            <span>
                                Donna Jones
                     </span>
                        </div>
                        <span className="border left-685 top-288"></span>
                        ...
                        <span className="border left-685 top-336 border-36"></span>
                        <div className="only-box skyblue-box left-685 top-336 box-36 skyblue-dark">
                            <span>
                                Cynthia Reed
                     </span>
                        </div>
                        <span className="border left-685 top-372 border-36"></span>
                        <div className="only-box skyblue-box left-685 top-372 box-36 skyblue-dark">
                            <span>
                                Marilyn Henry
                     </span>
                        </div>
                        <span className="border left-795 top-288"></span>
                        ...
                        <span className="border left-795 top-336 border-36"></span>
                        <div className="only-box blue-box left-795 top-336 box-36 blue-dark">
                            <span>
                                Cynthia Reed
                     </span>
                        </div>
                        <span className="border left-795 top-372 border-36"></span>
                        <div className="only-box blue-box left-795 top-372 box-36 blue-dark">
                            <span>
                                Marilyn Henry
                     </span>
                        </div>
                        <span className="border left-905 top-288"></span>
                        ...
                        <span className="border left-905 top-336 border-36"></span>
                        <div className="only-box blue-box left-905 top-336 box-36 blue-dark">
                            <span>
                                Cynthia Reed
                     </span>
                        </div>
                        <span className="border left-905 top-372 border-36"></span>
                        ...
                        <span className="border left-25 top-432"></span>
                        ...
                        <span className="border left-25 top-480 border-36"></span>
                        <div className="only-box green-box left-25 top-480 box-36 green-dark">
                            <span>
                                Emily Wade
                     </span>
                        </div>
                        <span className="border left-25 top-516 border-36"></span>
                        <div className="only-box green-box left-25 top-516 box-36 green-dark">
                            <span>
                                Megan Reyn...
                     </span>
                        </div>
                        <span className="border left-135 top-432"></span>
                        ...
                        <span className="border left-245 top-480 border-36"></span>
                        <div className="only-box red-box left-245 top-480 box-36 red-dark">
                            <span>
                                Mary Knight
                     </span>
                        </div>
                        <span className="border left-245 top-516 border-36"></span>
                        <div className="only-box red-box left-245 top-516 box-36 red-dark">
                            <span>
                                Carolyn Peters
                     </span>
                        </div>
                        <span className="border left-355 top-432"></span>
                        ...
                        <span className="border left-465 top-480 border-36"></span>
                        <div className="only-box red-box left-465 top-480 box-36 red-dark">
                            <span>
                                Joan Warren
                     </span>
                        </div>
                        <span className="border left-465 top-516 border-36"></span>
                        <div className="only-box red-box left-465 top-516 box-36 red-dark">
                            <span>
                                Mary Wilson
                     </span>
                        </div>
                        <span className="border left-575 top-432"></span>
                        ...
                        <span className="border left-575 top-480 border-36"></span>
                        <div className="only-box orange-box left-575 top-480 box-36 orange-dark">
                            <span>
                                Theresa Pena
                     </span>
                        </div>
                        <span className="border left-575 top-516 border-36"></span>
                        <div className="only-box orange-box left-575 top-516 box-36 orange-dark">
                            <span>
                                Dorothy Diaz
                     </span>
                        </div>
                        <span className="border left-685 top-432"></span>
                        ...
                        <span className="border left-685 top-480 border-36"></span>
                        <div className="only-box skyblue-box left-685 top-480 box-36 skyblue-dark">
                            <span>
                                Cynthia Reed
                     </span>
                        </div>
                        <span className="border left-685 top-516 border-36"></span>
                        <div className="only-box skyblue-box left-685 top-516 box-36 skyblue-dark">
                            <span>
                                Marilyn Henry
                     </span>
                        </div>
                        <span className="border left-795 top-432"></span>
                        ...
                        <span className="border left-795 top-480 border-36"></span>
                        <div className="only-box blue-box left-795 top-480 box-36 blue-dark">
                            <span>
                                Cynthia Reed
                     </span>
                        </div>
                        <span className="border left-795 top-516 border-36"></span>
                        <div className="only-box blue-box left-795 top-516 box-36 blue-dark">
                            <span>
                                Marilyn Henry
                     </span>
                        </div>
                        <span className="border left-905 top-432"></span>
                        ...
                        <span className="border left-905 top-480 border-36"></span>
                        <div className="only-box blue-box left-905 top-480 box-36 blue-dark">
                            <span>
                                Cynthia Reed
                     </span>
                        </div>
                        <span className="border left-905 top-516 border-36"></span>
