...
import { getUmpireCompetitionId, getOrganisationData } from 'util/sessionStorage';
...
const columnsDashboard = [
  ...
  {
    title: AppConstants.umpire1Response,
  ...
  {
    title: AppConstants.umpire2Response,
